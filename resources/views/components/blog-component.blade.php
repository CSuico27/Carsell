...
<div class="review-card p-4 sm:p-6 md:p-8 bg-white rounded-lg shadow-md space-y-4">
    <!-- Header -->
    ...
    <!-- Quote/Excerpt -->
    <a href="{{ route('blogs.show', $blog) }}" class="block text-sm sm:text-base font-mono text-justify break-words whitespace-pre-line line-clamp-3 leading-relaxed">
        “{{ $slot }}”
    </a>
